...
Np2DNumberArray = NewType("Np2DNumberArray", Annotated[np.ndarray, Is[lambda array:
                                                                      array.ndim == 2 and
                                                                      (np.issubdtype(array.dtype, np.number))]])

#: A type hint for a nD np.ndarray with dtype np.number
NpnDNumberArray = NewType("NpnDNumberArray", Annotated[np.ndarray, Is[lambda array:
                                                                      array.ndim > 0 and
                                                                      (np.issubdtype(array.dtype, np.number))]])

#: A type hint for a 3x3 np.ndarray matrix with dtype np.number
Np3x3NumberArray = NewType("Np2x2NumberArray", Annotated[np.ndarray, Is[lambda array:
                                                                        array.ndim == 2 and
                                                                        array.shape == (3, 3) and
                                                                        (np.issubdtype(array.dtype, np.number))]])

#: A type hint for a 2D np.ndarray with dtype np.integer
Np2DIntArray = NewType("Np2DIntArray", Annotated[np.ndarray, Is[lambda array:
                                                                array.ndim == 2 and
                                                                (np.issubdtype(array.dtype, np.integer))]])

#: A type hint for a 1D np.ndarray with dtype np.integer
Np1DIntArray = NewType("Np1DIntArray", Annotated[np.ndarray, Is[lambda array:
                                                                array.ndim == 1 and
