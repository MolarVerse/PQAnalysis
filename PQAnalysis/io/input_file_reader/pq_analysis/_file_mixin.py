...
class _FileMixin:
    ...
    Relative filenames are resolved against the directory of the input
    file (see ``PQAnalysisInputFileReader.resolve_path``).
    ...
    def traj_files(self) -> List[str] | None:
        ...
        return self.resolve_paths(
            _parse_files(self.dictionary, self.traj_files_key)
        )
    ...
    def out_file(self) -> str | None:
        ...
        return self.resolve_path(
            _parse_string(self.dictionary, self.out_file_key)
        )
    ...
    def log_file(self) -> str | None:
        ...
        return self.resolve_path(
            _parse_string(self.dictionary, self.log_file_key)
        )
    ...
    def moldescriptor_file(self) -> str | None:
        ...
        return self.resolve_path(
            _parse_string(self.dictionary, self.moldescriptor_file_key)
        )
    ...
    def restart_file(self) -> str | None:
        ...
        return self.resolve_path(
            _parse_string(self.dictionary, self.restart_file_key)
        )
