        ...
        for bond in bonded_topology.shake_bonds:
            ...
            lines.append(
                f"{bond.index1} {bond.index2} {
                    bond.equilibrium_distance} {linker}"
            )
