...
class AtomicSystem:
    ...
    from ._standardProperties import atoms, pos, vel, forces, charges, cell
    from ._properties import PBC, n_atoms, atomic_masses, mass, center_of_mass, combined_name
    from ._positions import nearest_neighbours
