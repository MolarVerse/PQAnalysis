...
.. list-table:: Optional keys
    ...
    * - Key
        - Value
    * - {Reader.r_max_key}
        - The maximum radius to calculate the MSD for.
    * - {Reader.r_min_key}
        - The minimum radius to calculate the MSD for.
    * - {Reader.delta_r_key}
        - The delta radius to calculate the MSD for.
    * - {Reader.n_bins_key}
        - The number of bins to calculate the MSD for.
    * - {Reader.log_file_key}
...
(for more information see :py:class:`~PQAnalysis.analysis.msd.msd.MSD`).
