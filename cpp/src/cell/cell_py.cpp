...
PYBIND11_MODULE(core_cell, m)
{
    ...
    py::class_<CoreCell>(m, "CoreCell")
        ...
        .def(
            ...
            &CoreCell::init_from_box_matrix,
            py::arg("box_matrix")
        )
        .def_property(
            "box_matrix",
            &CoreCell::get_box_matrix,
            &CoreCell::set_box_matrix
        )
        .def_property(
            "box_lengths",
            &CoreCell::get_box_lengths,
            &CoreCell::set_box_lengths
        )
        .def_property(
            "box_angles",
            &CoreCell::get_box_angles,
            &CoreCell::set_box_angles
        )
        ...
        .def(
            ...
            {
                return std::format(
                    "CoreCell(x={}, y={}, z={}, alpha={}, beta={}, gamma={})",
                    a.get_x(),
                    a.get_y(),
                    a.get_z(),
                    a.get_alpha(),
