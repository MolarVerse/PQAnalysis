...
Background for :doc:`vacf`: what sets the wavenumber axis and its resolution,
how apodization changes band shapes, what the normalization discards, and how
the two estimators differ in the tail.
